...
public class GameTypeSelectionScreen {

    protected FXSceneHandler sceneHandler;

    public GameTypeSelectionScreen(FXSceneHandler sceneHandler, Stage mainWindow) {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/game_type_selection_screen.fxml"),
        ...
        GameTypeSelectionScreenController controller = loader.getController();
